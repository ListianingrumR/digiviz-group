...
let divChapter2 =
  "<p style=margin-top:50px><b>Interactive Map of World GDP Growth(%)</b></p>" +
  '<iframe width="720" height="480" src= "world_gdp_2.html" frameBorder="0"</iframe>' +
  "<p><b>Global Housing Price Index </b></p>"+
  '<iframe width="720" height="480" src= "world_unemployment_rate.html" frameBorder="0"</iframe>'+
  "<p><b>Global Housing Price Index </b></p>" + "<hr>" +
  "<p> Interactive map"

// continue to next box/chapter
let divChapter3 =
  "<p><b>Interactive Map of unemployment rate(%)</b></p>" + "<hr>" +
  '<iframe width="720" height="480" src= "world_unemployment_rate.html" frameBorder="0"</iframe>' + "<hr>";
